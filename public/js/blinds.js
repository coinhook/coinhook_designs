var options = {
    imgSrc1:"https://pbs.twimg.com/media/FTJZ16SUUA8pP-c?format=jpg&name=4096x4096",
    imgSrc2:"https://pbs.twimg.com/media/FCUNcYMVEAIrJYo?format=png&name=4096x4096",
    containerName : "v_blinds",
    columns:10,
    margin:10
  }
  ...
  function VenetianBlinds(defaults)
  {
    ...
    var v_blinds = document.getElementsByClassName(defaults.containerName)[0];
    var directionX, directionY;
    
    var column, blind, blindImg;
    var bgImg, rot;
    var colL;
    var colW = (v_blinds.offsetWidth / cols) - margin;
        ...
        for (var j=0; j<4; j++)
          {
            ...
            blindImg.style.width = v_blinds.offsetWidth + "px";
